                        ...
                        rooms.map((room) => (
                            <TableRow key={room.roomNumber}>
                                ...
                                <TableCell className="px-6 py-4">
                                    <Button onClick={() => setSelectedRoom(room.roomNumber)}>Rent Room</Button>
                                </TableCell>
                            </TableRow>
                        ))
                    ) : (
                        <TableRow>
                            <TableCell colSpan={4} className="text-center">No rooms available</TableCell>
                        </TableRow>
                    )}
                </TableBody>
            </Table>
            ...
            {selectedRoom && (
                <div className="mt-4">
                    ...
                    <div className="mt-4 w-1/3">
                        <Button onClick={() => handleRentRoom(selectedRoom)} className="w-full">
                            Rent Room
                        </Button>
                    </div>
                </div>
